...
def demonstrate_font_features(demo_image_path, output_dir):
    """演示字体功能"""
    print("\n=== 演示字体功能 ===")
...
def demonstrate_preset_positions(demo_image_path, output_dir):
    """演示预设位置功能"""
    print("\n=== 演示预设位置功能 ===")
...
def demonstrate_rotation_features(demo_image_path, output_dir):
    """演示旋转功能"""
    print("\n=== 演示旋转功能 ===")
...
def demonstrate_combined_features(demo_image_path, output_dir):
    """演示组合功能"""
    print("\n=== 演示组合功能 ===")
